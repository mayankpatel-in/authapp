...
class IsSolutionProvider(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return bool(request.user and request.user.is_authenticated and request.user.is_sol_provider())

class IsSolutionSeeker(permissions.BasePermission):

    def has_permission(self, request, view):
        # check the user is authenticated and is a solution seeker
        return bool(request.user and request.user.is_authenticated and request.user.is_sol_seeker())
